...
var vm = new Vue({
    ...
    template: `
        ...
        <div class="row bg-dark text-white m-2">
            <nav class="nav nav-tabs">
                ...
                <div class="col-4 col-lg-2 text-dark"><button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#menu" aria-expanded="false" aria-controls="userPets"><h2><i class="bi-menu"></i> Menu</h2></button><div class="collapse" id="menu"><div class="card card-body"><h2><span class="lgout" v-on:click="SignIn"> Logout</span></h2><h2>Info</h2><h2>Pets</h2><h2>Posts</h2></div> </div></div>
            </nav>
        </div>
    ...
    <div class="row bg-light text-dark m-2">
                ...
                <section v-else> <div v-if="!authenticated" class="form-group text-center">
